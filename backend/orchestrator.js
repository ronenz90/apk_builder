...
class BuildOrchestrator {
  constructor({ buildId, zipPath, originalName, buildType, versionName, versionCode, packageName, outputDir, onLog, onStage, onSuccess, onError }) {
  ...
  triggerWorkflow(downloadUrl, callbackUrl) {
    ...
    this.log(`📦 Sending to GitHub: package_name='${this.packageName}'`);
